...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        question = Question(question='test question', answer='test answer', category='1', difficutly='1')
        question.insert()
    ...
    def test_add_question(self):
        new
        test_question = Question(question='test question', answer='test answer', category='1', difficutly='1')
        question.insert()
        question_id = question.id
    ...
    'CC - test created for 422 error code handler.
    def test_unprocessable(self):
        res = self.client().delete('/categories/12345')
        data = json.loads(res.data)
